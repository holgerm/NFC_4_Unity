...
public class NFCPlugin extends UnityPlayerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pendingIntent = PendingIntent.getActivity(NFCPlugin.this, 0,
                new Intent(NFCPlugin.this, getClass()).addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP), 0);
        ...
        if (mNfcAdapter == null) {
            Log.e(NFCPlugin.class.toString(), "This device doesn't support NFC.");
            finish();
            return;
        }
    ...
    private void handleIntent(Intent intent) {
        ...
        if (tag != null) {
            ...
            Log.i(NFCPlugin.class.toString(), s);
            value = s;
        }
    }
